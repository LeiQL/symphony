...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionedCampaignSpec) DeepCopyInto(out *VersionedCampaignSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionedCampaignSpec.
func (in *VersionedCampaignSpec) DeepCopy() *VersionedCampaignSpec {
	if in == nil {
		return nil
	}
	out := new(VersionedCampaignSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionedCatalogSpec) DeepCopyInto(out *VersionedCatalogSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionedCatalogSpec.
func (in *VersionedCatalogSpec) DeepCopy() *VersionedCatalogSpec {
	if in == nil {
		return nil
	}
	out := new(VersionedCatalogSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionedInstanceSpec) DeepCopyInto(out *VersionedInstanceSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionedInstanceSpec.
func (in *VersionedInstanceSpec) DeepCopy() *VersionedInstanceSpec {
	if in == nil {
		return nil
	}
	out := new(VersionedInstanceSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionedSolutionSpec) DeepCopyInto(out *VersionedSolutionSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionedSolutionSpec.
func (in *VersionedSolutionSpec) DeepCopy() *VersionedSolutionSpec {
	if in == nil {
		return nil
	}
	out := new(VersionedSolutionSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VersionedTargetSpec) DeepCopyInto(out *VersionedTargetSpec) {
	*out = *in
	if in.Metadata != nil {
		in, out := &in.Metadata, &out.Metadata
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VersionedTargetSpec.
func (in *VersionedTargetSpec) DeepCopy() *VersionedTargetSpec {
	if in == nil {
		return nil
	}
	out := new(VersionedTargetSpec)
	in.DeepCopyInto(out)
	return out
}
